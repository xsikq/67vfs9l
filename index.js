...
function title() {
	  ...
	  console.log(color(figlet.textSync(`${spc2}Chzklf-MD`, {
        font: 'Standard',
	  ...
	  console.log(color(`[•]`, 'aqua'), color(`Halo bang`, 'yellow'))
}
//COLOR
colors.setTheme({
warn:'yellow',
...
// OTHER
    ...
    let pa7rick = await conn.sendTextWithMentions(dill.from, `*Chzklf-Bot* tidak bisa menerima panggilan ${dill.isVideo ? `video` : `suara`}. Maaf @${dill.from.split('@')[0]} kamu akan diblockir. Jika tidak sengaja silahkan hubungi Owner untuk dibuka !`)
